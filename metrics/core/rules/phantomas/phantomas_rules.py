...
rules = {
    ...
    **assets_rules,
    ...
    'dom_length': make_rule(
        ...
        ok_threshold=1200,
        bad_threshold=1500,
        msg=_('A large DOM will increase memory usage, cause longer style'
    ...
    'dom_max_depth': make_rule(
        ...
        ok_threshold=16,
        bad_threshold=32,
        msg=_('A DOM with deep nested elements makes the CSS matching slower.')
    ),
    ...
    'accesses_count': make_rule(
        ...
        bad_threshold=1500,
        msg=_(
            'This estimates the how much times the JavaScript interact with the '
            'DOM'
    ...
    'old_tls_protocol': make_rule(
        ...
        bad_threshold=10,
        msg=_(
            "Counts the number of domains that use TLS versions < 1.3. This is "
            "the "
    ...
    'caching_not_specified': make_rule(
        ...
        bad_threshold=20,
        msg=_(
            "When no caching is specified, each browser will handle it "
            "differently."
    ...
    'not_found': make_rule(
        ...
        bad_threshold=1,
        msg=_(
            "404 errors are never cached, so each time a not found is reached, "
            "this"
